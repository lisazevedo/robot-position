...
% -------------------------------------------------------------------------------
% Informações gerais
    \thesistitle{Odometria indoor com Wi-Fi para robô móvel}
    \hidevolume
    \thesisvolume{Volume 1 of 1}
    \thesisauthor{Alfonso Martinez}
    \thesisauthorr{Domingos Neto}
    \thesisauthorrr{Leonardo Andrade}
    \thesisauthorrrr{Lis Azevedo}
    % \thesisadvisor{Prof. Marco Reis, M.Eng.}
    % \hidecoadvisor
    % \thesiscoadvisor{Marco Reis}
    \thesisdegreetitle{Bacharel em Engenharia}
    \thesismonthyear{Outubro de 2020}
% 
    \maketitlepage
%
% ----------------------------------------------------------------------------
